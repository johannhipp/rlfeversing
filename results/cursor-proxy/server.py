...
class ProxyHandler(BaseHTTPRequestHandler):
    ...
    server_version = "CursorProxy/0.1"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Capture Cursor Agent traffic through a local reverse proxy.")
    ...
    parser.add_argument("--upstream", default="https://api2.cursor.sh")
    parser.add_argument("--request-timeout", type=int, default=120)
    parser.add_argument("--log-secrets", action="store_true")
    parser.add_argument("--exchanges-log", default="../targets/cursor/proxy-exchanges.jsonl")
    parser.add_argument("--requests-dir", default="../targets/cursor/proxy-requests")
    parser.add_argument("--responses-dir", default="../targets/cursor/proxy-responses")
